// ==UserScript==
// @name         Universal AI Chat Exporter (v3.1)
// @namespace    https://github.com/sandroaguiar/exportfullchat2md-v3.1
// @version      3.1.07
// @description  Exporta conversas do ChatGPT, Claude e Perplexity com botão flutuante posicionado de forma segura.
...
(function() {
    ...
    function createFloatingButton() {
        ...
        // POSIÇÃO SEGURA: Afastado 170px da direita para não cobrir o botão nativo de scroll das IAs
        button.style.cssText = 'position: fixed !important; bottom: 20px !important; right: 170px !important; z-index: 2147483647 !important; padding: 10px 16px !important; border-radius: 8px !important; background-color: #10a37f !important; color: white !important; border: none !important; cursor: pointer !important; font-size: 13px !important; font-weight: bold !important; box-shadow: 0px 4px 10px rgba(0,0,0,0.3) !important; transition: opacity 0.2s !important; display: block !important;';

        var hostname = window.location.hostname;
        if (hostname.indexOf('claude.ai') !== -1) {
            button.style.backgroundColor = '#da7756 !important';
        } else if (hostname.indexOf('perplexity.ai') !== -1) {
            button.style.backgroundColor = '#20b8cd !important';
        }
    ...
    const PerplexityAdapter = {
        ...
        toMarkdownData: function(data, title, includeImages) {
            ...
            // Data de criação global do thread para fallback caso a entrada não tenha timestamp próprio
                ...
                if (citedNums.length > 0) {
                    ...
                    for (const n of citedNums) {
                        ...
                        if (w?.url) {
                            ...
                            // Se for link de anexo S3 da AWS do Perplexity, limpa e exibe o nome amigável do arquivo
                            ...
                            // Formato limpo para evitar poluição visual de URLs gigantescas
