...
// @version      3.1.25
// @description  Exporta conversas do ChatGPT, Claude e Perplexity com botão flutuante seguro, sanitização de links, cores dedicadas e créditos de versão no arquivo exportado.
...
(function() {
    ...
    async function startExportProcess() {
        ...
        try {
            ...
            lines.push('**Data:** ' + displayDate + ' | **Fonte:** [' + result.source + '](' + url + ') | **Exportador:** Universal AI Chat Exporter 3.1.25\n');
            lines.push('---\n');
